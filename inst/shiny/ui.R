                       ...
                       box(
                         ...
                         conditionalPanel(
                           ...
                           bsTooltip(id = "mathscore_withintumor",
                                     ...
                                     placement = "top",
                                     trigger = "hover"),
                           checkboxInput('mathscore_useadjvaf', label = div(style = "font-size:1.5em; font-weight:600; padding-left:15px", 'Use adjusted vaf'),value = TRUE, width = 400),
                           bsTooltip(id = "mathscore_useadjvaf",
                                     title = "Let VAF = VAF_adj, Tumor_Average_VAF = Tumor_Average_VAF_adj.Default: TRUE. ",
                                     placement = "top",
                                     trigger = "hover"),
                             ...
                             box(
                               ...
                               conditionalPanel(
                                 ...
                                 selectInput('treemutsig_level', label = div(style = "font-size:1.5em; font-weight:600; ", 'level'),
                                             choices = c('1','2','3', '4', '5'),selected = "2", width = 400),
