                       ...
                       box(
                         ...
                         conditionalPanel(
                           ...
                           bsTooltip(id = "mathscore_useadjvaf",
                                     ...
                                     placement = "top",
                                     trigger = "hover"),
                           checkboxInput('mathscore_usetumorlabel', label = div(style = "font-size:1.5em; font-weight:600; padding-left:15px", 'Use tumor label'),value = FALSE, width = 400),
                           bsTooltip(id = "mathscore_usetumorlabel",
                         ...
                         conditionalPanel(
                           ...
                           bsTooltip(id = "vafcluster_useadjvaf",
                                     ...
                                     placement = "top",
                                     trigger = "hover"),
                           checkboxInput('vafcluster_usetumorlabel', label = div(style = "font-size:1.5em; font-weight:600; padding-left:15px", 'Use tumor label'),value = FALSE, width = 400),
                           bsTooltip(id = "vafcluster_usetumorlabel",
                                     title = "Logical (Default: FALSE). Rename the 'Tumor_Sample_Barcode' with 'Tumor_Label'.",
                                     placement = "top",
                                     trigger = "hover"),
                         ...
                         conditionalPanel(
                             ...
                             bsTooltip(id = "ccfauc_useadjvaf",
                                       ...
                                       placement = "top",
                                       trigger = "hover"),
                             checkboxInput('ccfauc_usetumorlabel', label = div(style = "font-size:1.5em; font-weight:600; padding-left:15px", 'Use tumor label'),value = FALSE, width = 400),
                             bsTooltip(id = "ccfauc_usetumorlabel",
                                       title = "Logical (Default: FALSE). Rename the 'Tumor_Sample_Barcode' with 'Tumor_Label'.",
                                       placement = "top",
                                       trigger = "hover"),
                         ...
                         conditionalPanel(
                             ...
                             checkboxInput('calfst_usecircle',
                                           ...
                                           width = 500),
                             checkboxInput('calfst_usetumorlabel', label = div(style = "font-size:1.5em; font-weight:600; padding-left:15px", 'Use tumor label'),value = FALSE, width = 400),
                             bsTooltip(id = "calfst_usetumorlabel",
                                       title = "Logical (Default: FALSE). Rename the 'Tumor_Sample_Barcode' with 'Tumor_Label'.",
                                       placement = "top",
                                       trigger = "hover"),
                         ...
                         conditionalPanel(
                             ...
                             bsTooltip(id = "mutheatmap_useccf",
                                       ...
                                       placement = "top",
                                       trigger = "hover"),
                             checkboxInput('mutheatmap_usetumorlabel', label = div(style = "font-size:1.5em; font-weight:600; padding-left:15px", 'Use tumor label'),value = FALSE, width = 400),
                             bsTooltip(id = "mutheatmap_usetumorlabel",
                                       title = "Logical (Default: FALSE). Rename the 'Tumor_Sample_Barcode' with 'Tumor_Label'.",
                                       placement = "top",
                                       trigger = "hover"),
                             # bsTooltip(id = "mutheatmap_useccf",
                         ...
                         conditionalPanel(
                             ...
                             bsTooltip(id = "calneidist_usecircle",
                                       ...
                                       placement = "top",
                                       trigger = "hover"),
                             checkboxInput('calneidist_usetumorlabel', label = div(style = "font-size:1.5em; font-weight:600; padding-left:15px", 'Use tumor label'),value = FALSE, width = 400),
                             bsTooltip(id = "calneidist_usetumorlabel",
                                       title = "Logical (Default: FALSE). Rename the 'Tumor_Sample_Barcode' with 'Tumor_Label'.",
                                       placement = "top",
                                       trigger = "hover"),
                          ...
                          box(
                              ...
                              conditionalPanel(
                                  ...
                                  bsTooltip(id = "plotmutprofile_showColnames",
                                            ...
                                            placement = "top",
                                            trigger = "hover"),
                                  checkboxInput('plotmutprofile_usetumorlabel', label = div(style = "font-size:1.5em; font-weight:600; padding-left:15px", 'Use tumor label'),value = FALSE, width = 400),
                         ...
                         box(
                           ...
                           conditionalPanel(
                             ...
                             bsTooltip(id = "compareccf_minccf",
                                       ...
                                       placement = "top",
                                       trigger = "hover"),
                             checkboxInput('compareccf_usetumorlabel', label = div(style = "font-size:1.5em; font-weight:600; padding-left:15px", 'Use tumor label'),value = FALSE, width = 400),
                             bsTooltip(id = "compareccf_usetumorlabel",
                                       title = "Logical (Default: FALSE). Rename the 'Tumor_Sample_Barcode' with 'Tumor_Label'.",
                                       placement = "top",
                                       trigger = "hover"),
                           ...
                           conditionalPanel(
                               ...
                               bsTooltip(id = "comparejsi_minccf",
                                         ...
                                         placement = "top",
                                         trigger = "hover"),
                               checkboxInput('comparejsi_usetumorlabel', label = div(style = "font-size:1.5em; font-weight:600; padding-left:15px", 'Use tumor label'),value = FALSE, width = 400),
                               bsTooltip(id = "comparejsi_usetumorlabel",
                                         title = "Logical (Default: FALSE). Rename the 'Tumor_Sample_Barcode' with 'Tumor_Label'.",
                                         placement = "top",
                                         trigger = "hover"),
                               br(),
                             ...
                             box(
                               ...
                               conditionalPanel(
                                   ...
                                   bsTooltip(id = "plotphylotree_showbootstrap",
                                             ...
                                             placement = "top",
                                             trigger = "hover"),
                                   checkboxInput('plotphylotree_usetumorlabel', label = div(style = "font-size:1.5em; font-weight:600; padding-left:15px", 'Use tumor label'),value = FALSE, width = 400),
                                   bsTooltip(id = "plotphylotree_usetumorlabel",
                                             title = "Logical (Default: FALSE). Rename the 'Tumor_Sample_Barcode' with 'Tumor_Label'.",
                                             placement = "top",
                                             trigger = "hover"),
                                   # conditionalPanel(
                               ...
                               conditionalPanel(
                                   ...
                                   bsTooltip(id = "comparetree_showbootstrap",
                                             ...
                                             placement = "top",
                                             trigger = "hover"),
                                   checkboxInput('comparetree_usetumorlabel', label = div(style = "font-size:1.5em; font-weight:600; padding-left:15px", 'Use tumor label'),value = FALSE, width = 400),
                                   bsTooltip(id = "comparetree_usetumorlabel",
                                             title = "Logical (Default: FALSE). Rename the 'Tumor_Sample_Barcode' with 'Tumor_Label'.",
                                             placement = "top",
                                             trigger = "hover"),
                                   tags$table(
                               ...
                               conditionalPanel(
                                 ...
                                 bsTooltip(id = "treemutsig_mode",
                                           ...
                                           placement = "top",
                                           trigger = "hover"),
                                 checkboxInput('treemutsig_usetumorlabel', label = div(style = "font-size:1.5em; font-weight:600; padding-left:15px", 'Use tumor label'),value = FALSE, width = 400),
                                 bsTooltip(id = "treemutsig_usetumorlabel",
                                           title = "Logical (Default: FALSE). Rename the 'Tumor_Sample_Barcode' with 'Tumor_Label'.",
                                           placement = "top",
                                           trigger = "hover"),
