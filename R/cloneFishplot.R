...
#' 
#' @import htmlwidgets fishplot timescape clonevol ggsci
#' 
...
#' @param genotypePosition select corresponding clone positions for your timescape plot. Default "stack". "space" and "centre" are also available.
...
clonevol2Fishplot <- function(clusterTsvFile, plotOption, genotypePosition){
    ...
    if (plotOption == "fishplot"){
        ...
        clone_colours <- data.frame(clone_id = cloneList, 
                                    colour = pal_npg("nrc")(length(cloneList)))
        ## print timescape
        timescapeobject <- timescape(clonalPrev, 
                                     treeEdges, 
                                     mutations="NA", 
                                     ...
                                     alpha=50,
                                     genotype_position=genotypePosition, 
                                     perturbations="NA", 
                                     sort=FALSE,
                                     show_warnings=TRUE, 
...
schism2Fishplot <- function(schismCellularityFile, schismConsensusTree, plotOption, genotypePosition){
    ...
    if (plotOption == "fishplot"){
        ...
        clnoeList <- unique(clonalPrev$clone_id)
