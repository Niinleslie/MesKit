...
#' @param dirClusterCellularity specify the directory of cluster.cellularity document. Default NULL. If inferMethod == "SCHISM", the directory is essential and should be one of the outputs generated by  SCHISM.
#' @param dirGAconsensusTree specify the directory of GA.consensusTree document. Default NULL. However, if inferMethod == "SCHISM", the parameter should be one of the outputs generated by  SCHISM.
