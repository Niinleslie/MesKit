#' VAFCluster
#' @description Cluster variant allele frequencies (VAFs) based on a Gaussian finite mixture model and generate density distribution plots.
#'  
...
#' "compare" option prints comparison of VAFs distribution among samples via ggridges.
#' "combine" option prints multiple plots of VAFs distribution of samples on a page.
#' "separate" option returns a list of VAFs distribution plots for every sample.
#' @param themeOption Select a theme palette from ggsci. Default "aaas". Option: other palette from ggsci. 
#' 
#' @examples
