...
#' @param minVaf Default: 0. Option: on the scale of 0 to 1. The minimum value of vaf
#' @param maxVaf Default: 0. Option: on the scale of 0 to 1. The maximum value of vaf
#' @param showMATH Default TRUE. Option: FALSE. Show MATH Scores or hide them.
...
#' "combine" will output a picture with all separate VAF frequency distribution pictures.
#' "separate" will provide a list of VAF plots forevery samples from the patient.
#' @param themeOption Default "aaas". Option: other palette from ggsci. Select a theme palette from ggsci.
#' 
