...
vafCluster <-function(maf, plotOption="OFA", 
                    ...
                    showMATH=TRUE)
{
    ...
    if ((plotOption == "All") | (plotOption == "MIX")){
        lsPicName <- c()
...
## Functions for specific plotOption: "All", "MIX", "tsb"
## VAF painter
...
## Functions for specific plotOption: "OFA"
## VAF painter for OFA
