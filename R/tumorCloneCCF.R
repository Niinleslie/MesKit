...
#' @param clone.min.mut specify the minimum mutation number of a subclone. Default: 5
#' @param clone.min.aveCCF specify the minimum average CCF value of a subclone. Default: 0.1
#' 
