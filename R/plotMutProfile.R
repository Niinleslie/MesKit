...
#' @param class classify SSNVs/Indels into Shared/P-shared/Private("SP")/, Clonal/Subclonl ("CS")
#' or Shared-Clonal/P-shared-Clonal/Private-Clonal/Shared-Subclonal/P-shared-SubClonal/Private-SubClonal ("SPCS")
#' ,default is "SP" 
#' @param title the first half of the plot's title, default is "Mutational profile"
