...
#Pathway analysis
Pathway.njtree.shiny <- function(njtree, pathway.type = "KEGG", pval = 0.05, pAdjustMethod = "BH",
                           qval = 0.2, outdir = NULL, Name = 'All', savePlot = TRUE, plotType = "dot", showCategory = NULL){
