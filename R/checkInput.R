...
#' @param object phyloTree or phyloTreeList object generated by \code{\link{getPhyloTree}} function.
...
#' @param object Maf or MafList object generated by \code{\link{readMaf}} function.
#' @param patient.id Select the specific patients. Default: NULL, all patients are included.
