...
#' @param branchCol Specify the colors of branches (Default: mutType). Other options: "mutSig" for coloring branches by branch mutation signature; "mutSig" for coloring branches by mutation signature. 
