#' getMutMatrix
#' @description get the sorted binary or ccf mutation matrix
#' 
#' @param maf_data The data information of the Maf object generated by \code{\link{readMaf}} function.
#' @param use.ccf Whether to use the ccf data in the data, default FALSE
#' 
