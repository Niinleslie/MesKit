...
#' @param oncogeneListFile The document with oncogenes list .
#' @param tsgListFile Tumor suppressors genes(TSGs) list.
#' @param show.percentage Logical parameter that determine whether the percentage of different intersections will print in the stack plot or not. Default FALSE. Option: TRUE. 
#'
#' @examples
