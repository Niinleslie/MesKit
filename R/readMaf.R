...
#' @param ccfClusterTsvFile CCF file of cluster generated by PyClone. Default NULL. 
#' @param ccfLociTsvFile CCF file of mutated site generated by PyClone. Default NULL. 
