...
#' 
#' @examples
#' treeMSOutput <- treeMutationalSig(phyloTree, driverGenesFile=NULL, mutThreshold=50, signaturesRef="cosmic")
#' @import reshape2 dplyr
#' @export treeMutationalSig


## Mutational Signature function
treeMutationalSig <- function(phyloTree, driverGenesFile=NULL, mutThreshold=50, signaturesRef="cosmic"){
