...
#' @param min.mut.num the threshold for the variants in a branch. Default 50.
...
#' 
#' @examples
#' treeMSOutput <-  treeMutSig(phyloTree, driverGenesFile=NULL, min.mut.num=50, signaturesRef="cosmic")
#' @import reshape2 dplyr
#' @export  treeMutSig


## Mutational Signature function
 treeMutSig <- function(phyloTree, driverGenesFile=NULL, min.mut.num=50, signaturesRef="cosmic"){
